...
namespace HelloWorld {
    ...
    public class program {
        static void Main(string[] args) 
        {
            ...
            //,"dcr_graphs/r2.xml","dcr_graphs/r3.xml","dcr_graphs/r4.xml","dcr_graphs/r5.xml","dcr_graphs/r6.xml","dcr_graphs/r7.xml","dcr_graphs/r8.xml"
            foreach(var dcr_xml in dcr_graphs)
            {
                ...
                foreach (var list in debuggin)
                {
                    ...
                    //Console.WriteLine(graph.marking.pending);
